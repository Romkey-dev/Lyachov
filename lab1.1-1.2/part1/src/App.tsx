...
function App() {
  ...
  // Функция удаления задачи (Реализация: используем filter для создания нового массива без удаляемой задачи)
  const removeTask = (id: number) => {
    setTasks(tasks.filter(task => task.id !== id));
  };

  // Функция переключения статуса задачи (Реализация: используем map для обновления массива)
